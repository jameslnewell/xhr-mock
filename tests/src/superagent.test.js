      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, superagent.get('/')];
          case 1:
            res = _a.sent();
            chai_1.expect(res.status).to.eq(200);
            // expect(res.statusText).to.eq('OK');
            chai_1.expect(res.header).to.have.property('content-length', '12');
            chai_1.expect(res.text).to.eq('Hello World!');
            return [2 /*return*/];
        }
      });
    });
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, superagent.post('/').send({foo: 'bar'})];
          case 1:
            res = _a.sent();
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, superagent.put('/').send({foo: 'bar'})];
          case 1:
            res = _a.sent();
            chai_1.expect(res.status).to.eq(200);
            // expect(res.statusText).to.eq('Created');
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, superagent['delete']('/')];
          case 1:
            res = _a.sent();
            chai_1.expect(res.status).to.eq(204);
            // expect(res.statusText).to.eq('No Content');
            chai_1.expect(res.header).not.to.have.property('content-length', '12');
            chai_1.expect(res.text).to.eq('');
            return [2 /*return*/];
        }
      });
    });
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            chai_1.expect(error_2.message.toLowerCase()).to.contain('terminated');
            return [3 /*break*/, 4];
          case 4:
            return [2 /*return*/];
        }

...
var MockXMLHttpRequest = require('../src/MockXMLHttpRequest');
...
describe('MockXMLHttpRequest', function() {
  ...
  describe('.send()', function() {
    ...
    it('should time out after 100ms even though the timeout is set to timeout after 10ms', function(
      done
    ) {
      var start, end;
    ...
    it('should not time out after 100ms when the request has been aborted', function(
      done
    ) {
  ...
  describe('.addEventListener()', function() {
    ...
    it('should allow registering response progress event listener', function(
      done
    ) {
      MockXMLHttpRequest.addHandler(function(req, res) {
        res.progress(50, 100);
  ...
  describe('upload.addEventListener()', function() {
    ...
    it('should allow registering request progress event listener', function(
      done
    ) {
      MockXMLHttpRequest.addHandler(function(req, res) {
        req.progress(50, 100);

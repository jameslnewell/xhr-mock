...
MockXMLHttpRequest.prototype.open = function(method, url, async, user, password) {
  ...
  this.path     = parsedUrl.path.replace(/\?.*/, "");
  this.query    = parsedUrl.query;
  this.baseUrl  = [parsedUrl.protocol, "/", this.host, this.path].join("/");
  this.async    = async;
  this.user     = user;
...
MockXMLHttpRequest.prototype.send = function(data) {
  var self = this,
      response = MockXMLHttpRequest.handle(new MockRequest(self)),
      send_internal = function() {
